      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a 
              href="https://api.whatsapp.com/send?phone=5519989321226&text=Ol%C3%A1,%20gostaria%20de%20tirar%20uma%20d%C3%BAvida%20sobre%20os%20comandos%20do%20ChatGPT%20para%20terapeutas" 
              target="_blank" 
              rel="noopener noreferrer"
              className="glass-button inline-flex items-center gap-2 px-8 py-4"
            >
